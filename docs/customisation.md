...
| `--birdone-surface` | `#282828` | Pane grey in dark mode (folder pane, message list, reading pane) |
...
`userContent.css` (mail body in dark message mode) can't read variables
